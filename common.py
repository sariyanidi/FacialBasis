...
# chosen_feats = ['lb', 'rb', 'no', 'le', 're', 'mo']
chosen_feats = ['lb', 'rb', 'no', 'le', 're', 'ul', 'll']
...
rel_ids = {'lb': np.array(list(range(0, 5))),
             ...
             'mo': np.array(list(range(31, 37))+list(range(43, 47))+list(range(37, 43))+list(range(47, 51))),
             'all': np.array(list(range(0, 51)))}
